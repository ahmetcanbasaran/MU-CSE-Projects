...
# Title: File Transfer 1
# Generated: Mon Jul 17 16:10:58 2017
##################################################
...
class file_transfer_1(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="File Transfer 1")
        ...
        self.uhd_usrp_source_0.set_center_freq(2.46e9, 0)
        ...
        self.uhd_usrp_sink_0.set_center_freq(2.46e9, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/users/ceng513/oguzhan/Documents/File_Transfer/Transfered', True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/users/ceng513/oguzhan/Documents/File_Transfer/Received', False)
...
def main(top_block_cls=file_transfer_1, options=None):
